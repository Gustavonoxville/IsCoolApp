...
public class URL {
   ...
   // public static final String SEND_URL_FOTO = "http://" + Constante.ipConnection + "correcao/uploadedImagem";
    ...
    public static final String URL_EXIBIR_EXPLICACAO_ALUNO = "http://" + Constante.ipConnection + "explicacao/listar/";

    public static final String URL_EXIBIR_FEED_ALUNO = "http://" + Constante.ipConnection + "feed/lista";
